  ...
  return (
    <div className="max-w-4xl mx-auto p-4 bg-white rounded-lg shadow-sm border border-gray-200 mt-8">
      ...
      <div className="">        
        ...
        <textarea rows={10} onChange={e => setContent(e.target.value)} id="content" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder='write content here...'  />
      </div>
